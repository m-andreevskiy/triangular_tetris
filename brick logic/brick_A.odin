...
offset_A: Vector2 = {0.5, 0.5}

getBrickStructure_A :: proc () -> [4][dynamic]BrickCell {
  ...
  append(&structure[1],
          ...
          BrickCell{position = {0, 1}, tr = true},
  )
...
canRotate_A :: proc (brick: BrickEx, env: Environment) -> bool {
	dangerCell1 : Cell
	dangerCell2 : Cell
	dangerCell3 : Cell
	dangerCell4 : Cell
  ...
  switch brick.rotation {
    case 0, 2:
      ...
      if ( dangerCell1.tr || dangerCell1.br || dangerCell1.bl || dangerCell1.tl
        ...
        || cautiousCell1.br || cautiousCell1.bl || cautiousCell1.tl
        || cautiousCell2.tr || cautiousCell2.br || cautiousCell2.tl
      ){
        return false
      }
    ...
    case 1, 3:
      ...
      if ( dangerCell1.tr || dangerCell1.br || dangerCell1.bl || dangerCell1.tl
        ...
        || dangerCell3.tr || dangerCell3.br || dangerCell3.bl || dangerCell3.tl
        || dangerCell4.tr || dangerCell4.br || dangerCell4.bl || dangerCell4.tl
        || cautiousCell1.tr || cautiousCell1.br || cautiousCell1.bl
        || cautiousCell2.tr || cautiousCell2.bl || cautiousCell2.tl
      ){
        return false
      }
  }
